...
public class App02 {
  ...
  public static void main(String[] args) {
    ...
    BoardHandler02 boardHandler = new BoardHandler02("게시판1 ", scn);
    BoardHandler02 boardHandler2 = new BoardHandler02("게시판2 ", scn);
    MemberHandler02 memberHandler = new MemberHandler02("일반 ", scn);
    ComputeHandler02 computeHandler = new ComputeHandler02(scn);
